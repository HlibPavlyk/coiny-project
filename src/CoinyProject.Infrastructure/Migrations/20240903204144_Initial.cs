    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DiscussionRate = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AlbumElementId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StartPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    BetDelta = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.AlbumElementId,
                        principalTable: "AlbumElements",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "FavoriteAlbumElements",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteAlbumElements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteAlbumElements_AlbumElements_AlbumElementId",
                        column: x => x.AlbumElementId,
                        principalTable: "AlbumElements",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FavoriteAlbumElements_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteAlbumElements_AlbumElementId",
                table: "FavoriteAlbumElements",
                column: "AlbumElementId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteAlbumElements_UserId",
                table: "FavoriteAlbumElements",
                column: "UserId");
        }
