...
namespace CoinyProject.Infrastructure.Migrations
{
    ...
    [Migration("20240304161548_testMigration")]
            ...
            modelBuilder.Entity("CoinyProject.Domain.Entities.AlbumElement", b =>
                {
                    b.HasOne("CoinyProject.Domain.Entities.AlbumElementAccessibility", "Accessibility")
                        ...
                        .HasForeignKey("CoinyProject.Domain.Entities.AlbumElement", "AccessibilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CoinyProject.Domain.Entities.User", b =>
                {
                    b.HasOne("CoinyProject.Domain.Entities.UserRole", "Role")
                        .WithOne("User")
                        .HasForeignKey("CoinyProject.Domain.Entities.User", "UserRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
