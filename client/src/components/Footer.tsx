...
export function Footer() {
  return (
    <footer className="bg-surface border-t border-border mt-16 px-7 pt-10 pb-7">
      <div className="max-w-[1280px] mx-auto grid gap-10" style={{ gridTemplateColumns: '1.5fr 1fr 1fr 1fr' }}>
        <div>
          <Logo />
