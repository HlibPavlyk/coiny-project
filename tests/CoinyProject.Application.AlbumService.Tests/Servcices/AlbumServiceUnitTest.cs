    ...
    //     public async Task AddAlbum_ReturnsException_IfInputArgumentsAreNull(AlbumPostDto? albumCreating, string? userId)
    //     {
    //         Mock<IUnitOfWork> unitOfWork = new();
    //         Mock<IAlbumRepository> albumRepository = new();
    //
    ...
    //
    //         var element = _fixture.Build<AlbumElementPostDto>()
    //             .Create();
    //
    ...
    //     [Theory]
    //     [InlineData(null)]
    //     public async Task AddAlbumElement_ReturnsException_IfInputArgumentsAreNull(AlbumElementPostDto? albumCreating)
    //     {
    //         Mock<IUnitOfWork> unitOfWork = new();
    //         Mock<IAlbumRepository> albumRepository = new();
    //
